    ...
    <div className="flex flex-col items-center justify-center p-6 text-center bg-gradient-to-b from-yellow-50 to-white rounded-lg shadow-md hidden md:block my-10 mx-20 animate-fadeUp">
      <div className="flex flex-col items-start justify-center mb-10">
        ...
        <div className="flex gap-5">
          ...
          <button onClick={handleSignIn} className="px-5 py-2 bg-gradient-to-b from-yellow-50 to-white border-2 border-yellow-500 text-gray-900 font-semibold rounded-full shadow-lg transition duration-300 transform hover:scale-105">
            Create Account
          </button>
        </div>
      </div>
